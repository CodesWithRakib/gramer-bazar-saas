...
import { useGetAdminDisputesQuery } from '@/features/disputes/disputesApi';
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">All Disputes</h1>
      </div>

      {disputes?.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center shadow-sm border border-gray-100 dark:border-gray-700">
          <p className="text-gray-500 dark:text-gray-400">There are no active disputes.</p>
        </div>
      ) : (
