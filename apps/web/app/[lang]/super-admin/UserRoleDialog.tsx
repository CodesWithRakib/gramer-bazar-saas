...
const ALL_ROLES = [Role.CUSTOMER, Role.SELLER, Role.RIDER, Role.ADMIN, Role.SUPER_ADMIN];
...
export function UserRoleDialog({
  ...
  const rolesToDisplay = isSuperAdminMode
    ? ALL_ROLES
    : ALL_ROLES.filter((r) => r !== Role.SUPER_ADMIN);
